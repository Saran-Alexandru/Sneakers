...
const Product = () => {
  ...
  return (
    <div>
      ...
      <div className="sm:ml-[286px] sm:px-6 sm:py-7 mt-[6rem] max-w-[1331px] lg:px-10 m-[1.1875rem]">
        <h2 className="text-3xl sm:text-5xl text-grafont-mono font-bold text-[#111827] mb:w-[442px]">
          Explore the Sneaker Collection
        </h2>

        <div className="mt-6 mb-6 grid grid-cols-2 gap-x-6 gap-y-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 ">
